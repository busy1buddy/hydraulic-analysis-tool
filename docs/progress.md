...
- L6: REST API mode — lightweight HTTP server, 10 endpoints (health, load, steady, topology, fingerprint, diagnose, compliance, nodes, pipes, sensitivity)
- L10: Batch analysis — run multiple .inp files through configurable analysis pipeline
