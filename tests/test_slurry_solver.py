...
class TestPowerLaw:
    def test_shear_thinning(self):
        from epanet_api.slurry_solver import power_law_headloss
...
class TestHerschelBulkley:
    def test_general_model(self):
        from epanet_api.slurry_solver import herschel_bulkley_headloss
...
class TestSlurryDatabase:
    def test_list_fluids(self):
        from epanet_api.slurry_solver import list_fluids
        fluids = list_fluids()
    ...
    def test_network_analysis(self, loaded_network):
        from epanet_api.slurry_solver import analyze_slurry_network
